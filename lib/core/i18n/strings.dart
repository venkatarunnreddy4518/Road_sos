...
class AppStrings {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'reject': {'en': 'Reject', 'hi': 'अस्वीकार करें', 'te': 'తిరస్కరించు', 'ta': 'நிராகரி'},
    ...
    // ── Helper Types ──
    'type_tyre_repair': {'en': 'Tyre repair', 'hi': 'टायर मरम्मत', 'te': 'టైర్ రిపేరు', 'ta': 'டயர் பழுதுபார்ப்பு'},
    'type_fuel_delivery': {'en': 'Fuel delivery', 'hi': 'ईंधन वितरण', 'te': 'ఇంధన డెలివరీ', 'ta': 'எரிபொருள் விநியோகம்'},
    'type_mechanic': {'en': 'Mechanic', 'hi': 'मैकेनिक', 'te': 'మెకానిక్', 'ta': 'మెக்கானிக்'},
    ...
    'pickup': {'en': 'Pickup', 'hi': 'पिकअप', 'te': 'పికప్', 'ta': 'பிக்அப்'},
    'need_help_with': {'en': 'Need help with', 'hi': 'मदद की आवश्यकता है', 'te': 'సహాయం కావాలి', 'ta': 'உதவி தேவை'},
    ...
    'nearby_placeholder': {'en': 'Nearby Helpers Map & List', 'hi': 'आस-पास के सहायक मानचित्र और सूची', 'te': 'సమీప సహాయకుల మ్యాప్ మరియు జాబితా', 'ta': 'அருகிலுள்ள உதவியாளர்களின் வரைபடம் மற்றும் பட்டியல்'},
    'travel_placeholder': {'en': 'Travel Mode & Route Support', 'hi': 'यात्रा मोड और मार्ग सहायता', 'te': 'ప్రయాణ మోడ్ మరియు రూట్ మద్దతు', 'ta': 'பயண முறை மற்றும் வழி ஆதரவு'},
    'pick_category_prompt': {'en': 'Pick a category from Home to request this helper.', 'hi': 'इस सहायक का अनुरोध करने के लिए होम से एक श्रेणी चुनें।', 'te': 'ఈ సహాయకుడిని అభ్యర్థించడానికి హోమ్ నుండి ఒక కేటగిరీని ఎంచుకోండి.', 'ta': 'இந்த உதவியாளரைக் கோர முகப்பில் இருந்து ஒரு வகையைத் தேர்ந்தெடுக்கவும்.'},
    'reviews': {'en': 'Reviews', 'hi': 'समीक्षाएं', 'te': 'సమీక్షలు', 'ta': 'மதிப்புரைகள்'},
    'mark_on_the_way': {'en': 'Mark as On the way', 'hi': 'रास्ते में चिह्नित करें', 'te': 'దారిలో ఉన్నట్లు గుర్తించండి', 'ta': 'வழியில் உள்ளதாக குறிக்கவும்'},
    'mark_arrived': {'en': 'Mark as Arrived', 'hi': 'आ गया चिह्नित करें', 'te': 'చేరుకున్నట్లు గుర్తించండి', 'ta': 'வந்து சேர்ந்ததாக குறிக்கவும்'},
    'mark_completed': {'en': 'Mark as Completed', 'hi': 'पूर्ण चिह्नित करें', 'te': 'పూర్తయినట్లు గుర్తించండి', 'ta': 'நிறेவடைந்ததாக குறிக்கவும்'},
    'choose_partner': {'en': 'Choose a partner', 'hi': 'एक साथी चुनें', 'te': 'భాగస్వామిని ఎంచుకోండి', 'ta': 'ஒரு கூட்டாளரைத் தேர்ந்தெடுக்கவும்'},
    'view_options': {'en': 'View {type} options', 'hi': '{type} विकल्प देखें', 'te': '{type} ఎంపికలను వీక్షించండి', 'ta': '{type} விருப்பங்களைக் காண்க'},
    'finding_partners': {'en': 'Finding nearby partners', 'hi': 'आस-पास के साथियों को ढूँढ रहे हैं', 'te': 'సమీప భాగస్వాములను కనుగొంటోంది', 'ta': 'அருகிலுள்ள கூட்டாளர்களைக் கண்டறிகிறது'},
    'sorted_arrival': {'en': 'Sorted by arrival time', 'hi': 'आगमन समय के अनुसार क्रमबद्ध', 'te': 'చేరుకునే సమయం ఆధారంగా క్రమబద్ధీకరించబడింది', 'ta': 'வருகை நேரத்தின்படி வரிசைப்படுத்தப்பட்டது'},
    'checking_availability': {'en': 'Checking live availability', 'hi': 'लाइव उपलब्धता की जांच की जा रही है', 'te': 'లైవ్ అందుబాటును తనిఖీ చేస్తోంది', 'ta': 'நேரடி கிடைக்கும் தன்மையை சரிபார்க்கிறது'},
    'partners_near': {'en': 'partners nearby', 'hi': 'पास में भागीदार', 'te': 'సమీపంలో భాగస్వాములు', 'ta': 'கூட்டாளர்கள் அருகில்'},
    'no_incoming_requests': {'en': 'No incoming requests', 'hi': 'कोई आने वाले अनुरोध नहीं', 'te': 'వచ్చే అభ్యర్థనలు లేవు', 'ta': 'வரும் கோரிக்கைகள் ஏதுமில்லை'},
    'register_desc': {'en': 'Register your service to receive nearby roadside requests.', 'hi': 'आस-पास के रोडसाइड अनुरोधों को प्राप्त करने के लिए अपनी सेवा पंजीकृत करें।', 'te': 'సమీప రోడ్‌సైడ్ అభ్యర్థనలను స్వీకరించడానికి మీ సేవను నమోదు చేయండి.', 'ta': 'அருகிலுள்ள சாலையோரக் கோரிக்கைகளைப் பெற உங்கள் சேவையைப் பதிவு செய்யவும்.'},
    'service_name': {'en': 'Service name', 'hi': 'सेवा का नाम', 'te': 'సేవ పేరు', 'ta': 'சேவை பெயர்'},
    'service_type': {'en': 'Service type', 'hi': 'सेवा का प्रकार', 'te': 'సేవ రకం', 'ta': 'சேவை வகை'},
    'contact_phone': {'en': 'Contact phone', 'hi': 'संपर्क फ़ोन', 'te': 'సంప్రదింపు ఫోన్', 'ta': 'தொடர்பு தொலைபேசி'},
    'welcome_back': {'en': 'Welcome back', 'hi': 'वापसी पर आपका स्वागत है', 'te': 'తిరిగి స్వాగతం', 'ta': 'மீண்டும் வருக'},
    'create_your_account': {'en': 'Create your account', 'hi': 'अपना खाता बनाएं', 'te': 'మీ ఖాతాను సృష్టించండి', 'ta': 'உங்கள் கணக்கை உருவாக்கவும்'},
    'enter_credentials': {'en': 'Enter your credentials to sign in', 'hi': 'साइन इन करने के लिए अपनी साख दर्ज करें', 'te': 'సైన్ ఇన్ చేయడానికి మీ ఆధారాలను నమోదు చేయండి', 'ta': 'உள்நுழைய உங்கள் சான்றுகளை உள்ளிடவும்'},
    'fill_details': {'en': 'Fill in the details to get started', 'hi': 'शुरू करने के लिए विवरण भरें', 'te': 'ప్రారంభించడానికి వివరాలను పూరించండి', 'ta': 'தொடங்குவதற்கு விவரங்களை நிரப்பவும்'},
    'full_name': {'en': 'Full name', 'hi': 'पूरा नाम', 'te': 'పూర్తి పేరు', 'ta': 'முழு பெயர்'},
    'your_full_name': {'en': 'Your full name', 'hi': 'आपका पूरा नाम', 'te': 'మీ పూర్తి పేరు', 'ta': 'உங்கள் முழு பெயர்'},
    'email_address': {'en': 'Email address', 'hi': 'ईमेल पता', 'te': 'ఇమెయిల్ చిరునామా', 'ta': 'மின்னஞ்சல் முகவரி'},
    'forgot_prompt': {'en': 'Forgot?', 'hi': 'भूल गए?', 'te': 'మర్చిపోయారా?', 'ta': 'மறந்துவிட்டீர்களா?'},
    'no_account_prompt': {'en': "Don't have an account? ", 'hi': 'खाता नहीं है? ', 'te': 'ఖాతా లేదా? ', 'ta': 'கணக்கு இல்லையா? '},
    'have_account_prompt': {'en': 'Already have an account? ', 'hi': 'पहले से ही एक खाता है? ', 'te': 'ఇప్పటికే ఖాతా ఉందా? ', 'ta': 'ஏற்கனவே கணக்கு உள்ளதா? '},
    'verify_otp': {'en': 'Verify OTP', 'hi': 'ओटीपी सत्यापित करें', 'te': 'OTPని ధృవీకరించండి', 'ta': 'OTP ஐ சரிபார்க்கவும்'},
    'phone_sign_in': {'en': 'Phone sign in', 'hi': 'फ़ोन साइन इन', 'te': 'ఫోన్ సైన్ ఇన్', 'ta': 'தொலைபேசி உள்நுழைவு'},
    'enter_verify_code': {'en': 'Enter verification code', 'hi': 'सत्यापन कोड दर्ज करें', 'te': 'ధృవీకరణ కోడ్ నమోదు చేయండి', 'ta': 'சரிபார்ப்பு குறியீட்டை உள்ளிடவும்'},
    'we_sent_code': {'en': 'We sent a 6-digit code to', 'hi': 'हमने एक 6 अंकों का कोड भेजा है', 'te': 'మేము 6 అంకెల కోడ్‌ను పంపాము', 'ta': 'நாங்கள் 6 இலக்க குறியீட்டை அனுப்பியுள்ளோம்'},
    'send_otp_hint': {'en': "We'll send you a one-time verification code", 'hi': 'हम आपको एक बार का सत्यापन कोड भेजेंगे', 'te': 'మేము మీకు ఒక సారి ధృవీకరణ కోడ్‌ను పంపుతాము', 'ta': 'ஒரு முறை சரிபார்ப்புக் குறியீட்டை உங்களுக்கு அனுப்புவோம்'},
    'name_optional': {'en': 'Name (optional)', 'hi': 'नाम (वैकल्पिक)', 'te': 'పేరు (ఐచ్ఛికం)', 'ta': 'பெயர் (விருப்பத்திற்குரியது)'},
    'your_name': {'en': 'Your name', 'hi': 'आपका नाम', 'te': 'మీ పేరు', 'ta': 'உங்கள் பெயர்'},
    'verification_code': {'en': 'Verification code', 'hi': 'सत्यापन कोड', 'te': 'ధృవీకరణ కోడ్', 'ta': 'சரிபார்ப்பு குறியீடு'},
    'dev_mode_hint': {'en': 'Dev mode: your code is', 'hi': 'देव मोड: आपका कोड है', 'te': 'దేవ్ మోడ్: మీ కోడ్', 'ta': 'தேவ் பயன்முறை: உங்கள் குறியீடு'},
    'verify_code': {'en': 'Verify code', 'hi': 'कोड सत्यापित करें', 'te': 'కోడ్‌ను ధృవీకరించండి', 'ta': 'குறியீட்டைச் சரிபார்க்கவும்'},
    'resend_code': {'en': 'Resend code', 'hi': 'कोड पुनः भेजें', 'te': 'కోడ్‌ను मళ్లీ పంపండి', 'ta': 'குறியீட்டை மீண்டும் அனுப்பு'},
    'ai_welcome_msg': {'en': 'Hello! I am your AI Roadside Mechanic. Tell me what\'s wrong with your vehicle, and I will help you diagnose the issue, provide safety tips, and guide you to find the right help.', 'hi': 'नमस्कार! मैं आपका एआई रोडसाइड मैकेनिक हूँ। मुझे बताएं कि आपके वाहन में क्या खराबी है, और मैं आपको समस्या का निदान करने, सुरक्षा सुझाव प्रदान करने और सही मदद खोजने में मार्गदर्शन करूँगा।', 'te': 'నమస్కారం! నేను మీ AI రోడ్‌సైడ్ మెకానిక్. మీ వాహనానికి ఏమైందో నాకు చెప్పండి, నేను సమస్యను గుర్తించడంలో, భద్రతా చిట్కాలను అందించడంలో మరియు సరైన సహాయాన్ని కనుగొనడంలో మీకు సహాయం చేస్తాను.', 'ta': 'வணக்கம்! நான் உங்கள் AI சாலையோர மெக்கானிக். உங்கள் வாகனத்தில் என்ன தவறு என்று சொல்லுங்கள், சிக்கலைக் கண்டறியவும், பாதுகாப்பு உதவிக்குறிப்புகளை வழங்கவும், சரியான உதவியைக் கண்டறியவும் நான் உங்களுக்கு உதவுவேன்.'},
    'ai_typing': {'en': 'AI Mechanic is typing...', 'hi': 'एआई मैकेनिक टाइप कर रहा है...', 'te': 'AI మెకానిక్ టైప్ చేస్తున్నారు...', 'ta': 'AI மெக்கானிக் தட்டச்சு செய்கிறார்...'},
    'ai_input_hint': {'en': 'Describe your issue...', 'hi': 'अपनी समस्या बताएं...', 'te': 'మీ సమస్యను వివరించండి...', 'ta': 'உங்கள் சிக்கலை விளக்குங்கள்...'},
    'ai_suggest_prefill': {'en': 'Find Help', 'hi': 'मदद पाएं', 'te': 'సహాయం పొందండి', 'ta': 'உதவி பெறுங்கள்'},
    'ai_chip_puncture': {'en': '🛞 Flat Tyre', 'hi': '🛞 फ्लैट टायर', 'te': '🛞 ఫ్లాట్ టైర్', 'ta': '🛞 தட்டையான டயர்'},
    'ai_chip_overheat': {'en': '🌡️ Engine Overheating', 'hi': '🌡️ इंजन ओवरहीटिंग', 'te': '🌡️ ఇంజిన్ వేడెక్కడం', 'ta': '🌡️ எஞ்சின் அதிக வெப்பமடைதல்'},
    'ai_chip_battery': {'en': '🔋 Dead Battery', 'hi': '🔋 डेड बैटरी', 'te': '🔋 డెడ్ బ్యాటరీ', 'ta': '🔋 இறந்த பேட்டரி'},
    'ai_chip_fuel': {'en': '⛽ Out of Fuel', 'hi': '⛽ ईंधन खत्म', 'te': '⛽ ఇంధనం అయిపోయింది', 'ta': '⛽ எரிபொருள் தீர்ந்தது'},
    'ai_prompt_puncture': {'en': 'I have a tyre puncture and need assistance changing it.', 'hi': 'मेरा टायर पंचर हो गया है और मुझे इसे बदलने में सहायता चाहिए।', 'te': 'నా టైర్ పంచర్ అయింది మరియు దానిని మార్చడానికి సహాయం కావాలి.', 'ta': 'எனது டயர் பஞ்சராகிவிட்டது, அதை மாற்ற உதவி தேவை.'},
    'ai_prompt_overheat': {'en': 'My engine temperature indicator is in the red. What should I do?', 'hi': 'मेरा इंजन तापमान संकेतक लाल रंग में है। मुझे क्या करना चाहिए?', 'te': 'నా ఇంజిన్ ఉష్ణోగ్రత ఇండికేటర్ రెడ్ లో ఉంది. నేను ఏమి చేయాలి?', 'ta': 'எனது எஞ்சின் வெப்பநிலை காட்டி சிவப்பு நிறத்தில் உள்ளது. நான் என்ன செய்ய வேண்டும்?'},
    'ai_prompt_battery': {'en': 'My car battery is dead and I need a jump start.', 'hi': 'मेरी कार की बैटरी खत्म हो गई है और मुझे जंप स्टार्ट की जरूरत है।', 'te': 'నా కార్ బ్యాటరీ డెడ్ అయింది మరియు నాకు జంప్ స్టార్ట్ కావాలి.', 'ta': 'எனது கார் பேட்டரி இறந்துவிட்டது, எனக்கு ஜம்ப் ஸ்டார்ட் தேவை.'},
    'ai_prompt_fuel': {'en': 'I have run out of fuel on the highway and need refuel assistance.', 'hi': 'हाइवे पर मेरा ईंधन खत्म हो गया है और मुझे ईंधन भरने की सहायता चाहिए।', 'te': 'హైవేపై నాకు ఇంధనం అయిపోయింది మరియు ఇంధనం నింపే సహాయం కావాలి।', 'ta': 'நெடுஞ்சாலையில் எனக்கு எரிபொருள் தீர்ந்துவிட்டது, எரிபொருள் நிரப்ப உதவி தேவை.'},
  };
